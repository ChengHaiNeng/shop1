...
<link href="/src/Bool/day29/shop1/Public/Admin/styles/general.css" rel="stylesheet" type="text/css" />
<link href="/src/Bool/day29/shop1/Public/Admin/styles/main.css" rel="stylesheet" type="text/css" />
</head>
<body>
...
<div class="form-div">
  ...
  <form action="" name="searchForm">
    <img src="/src/Bool/day29/shop1/Public/Admin/images/icon_search.gif" width="26" height="22" border="0" alt="SEARCH" />
...
<table cellpadding="3" cellspacing="1">
  <tr>
    <th>
      ...
      <a href="#">编号</a><img src="/src/Bool/day29/shop1/Public/Admin/images/sort_desc.gif"/>    </th>
  ...
  <tr>
    ...
    <td class="first-cell" style=""><span ><?php echo ($good['goods_name']); ?></span></td>
    <td><span ><?php echo ($good['goods_sn']); ?></span></td>
    <td align="right"><span ><?php echo ($good['shop_price']); ?>
    </span></td>
    <td align="center"><img src="/src/Bool/day29/shop1/Public/Admin/images/<?php echo ($good['is_on_sale']?'yes':'no'); ?>.gif"  /></td>
    <td align="center"><img src="/src/Bool/day29/shop1/Public/Admin/images/<?php echo ($good['is_best']?'yes':'no'); ?>.gif"  /></td>
    <td align="center"><img src="/src/Bool/day29/shop1/Public/Admin/images/<?php echo ($good['is_new']?'yes':'no'); ?>.gif"  /></td>
    <td align="center"><img src="/src/Bool/day29/shop1/Public/Admin/images/<?php echo ($good['is_hot']?'yes':'no'); ?>.gif"  /></td>

    <td align="center"><span >100</span></td>
        <td align="right"><span ><?php echo ($good['goods_number']); ?></span></td>
        <td align="center">
      <a href="#" target="_blank" title="查看"><img src="/src/Bool/day29/shop1/Public/Admin/images/icon_view.gif" width="16" height="16" border="0" /></a>
      <a href="#" title="编辑"><img src="/src/Bool/day29/shop1/Public/Admin/images/icon_edit.gif" width="16" height="16" border="0" /></a>
      <a href="#" title="复制"><img src="/src/Bool/day29/shop1/Public/Admin/images/icon_copy.gif" width="16" height="16" border="0" /></a>
      <a href="<?php echo U('Admin/Goods/goodsdel',array('goods_id'=>$good['goods_id']));?>"  title="回收站"><img src="/src/Bool/day29/shop1/Public/Admin/images/icon_trash.gif" width="16" height="16" border="0" /></a>
      <a href="#" title="货品列表"><img src="/src/Bool/day29/shop1/Public/Admin/images/icon_docs.gif" width="16" height="16" border="0" /></a>          </td>
