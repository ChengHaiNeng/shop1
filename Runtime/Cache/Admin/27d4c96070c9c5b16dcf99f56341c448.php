...
<table width="100%" cellspacing="1" cellpadding="2" id="list-table">
  ...
  <?php if(is_array($catlist)): foreach($catlist as $key=>$v): ?><tr align="center" class="0" id="0_1" id = 'tr_1'>
    ...
    <td width="24%" align="center">
      <a href="#">转移商品</a> |
      <a href="<?php echo U('Admin/Cat/cateedit',array('cat_id'=>$v['cat_id']));?>">编辑</a> |
      <a href="<?php echo U('Admin/Cat/del',array('cat_id'=>$v['cat_id']));?>" title="移除">移除</a>
    </td>
