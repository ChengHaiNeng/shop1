...
<div class="block1">
  ...
  <span class="lb"></span><span class="rb"></span>
   <ul id="top10">
  <?php if(is_array($history)): foreach($history as $key=>$his): ?><li>
       <div class="first">
        <div class="fl">
        <font style="color:#F00; font-weight:bold"><?php echo ($his['goods_id']); ?>.</font> <a href="" title=""><?php echo ($his['goods_name']); ?></a>
        </div>
...
<div class="clearfix modContent"> 
    <form name="compareForm" action="" method="post">
        ...
        <?php if(is_array($cat_goods)): foreach($cat_goods as $key=>$cat_good): ?><div class="goodsbox1" style="margin: 5px 9px 8px 8px;*margin:5px 6px 10px 14px;">
        <div class="imgbox1"><a href="<?php echo U('Home/Goods/goods',array('goods_id'=>$cat_good['goods_id']));?>"><img src="<?php echo ($cat_good['goods_img']); ?>"></a></div>
        <a href="" title="ECSHOP模板中心68ecshop.com测试商品"><?php echo ($cat_good['goods_name']); ?></a><br>
        <font class="market">￥<?php echo ($cat_good['market_price']); ?>元</font> 
        <b class="f1">￥<?php echo ($cat_good['shop_price']); ?>元</b><br>
