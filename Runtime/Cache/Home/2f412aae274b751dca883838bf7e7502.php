...
<link rel="icon" href="/Public/Home/images/animated_favicon.gif" type="image/gif">
...
<div class="block1">
    ...
    <?php if(check_cookie() == 1): ?><a href="" style="color:#50884b"><?php echo (cookie('username')); ?></a> | 
...
<?php if(is_array($cat)): foreach($cat as $key=>$v): if($v['parent_id'] == 0): ?><dl>
    <dt><a href=""><?php echo ($v['cat_name']); ?></a></dt>
    <dd class="clearfix"> 
    <?php if(is_array($cat)): foreach($cat as $key=>$sub): if($v['cat_id'] == $sub['parent_id']): ?><p class=""><a href="<?php echo U('Home/Cat/cat',array('cat_id'=>$sub['cat_id']));?>" title="CDMA手机" class="txtdot"><?php echo ($sub['cat_name']); ?></a></p><?php endif; endforeach; endif; ?> 
    </dd>
...
<div class="recommendContent entry-content" id="show_hot_area">
      <?php if(is_array($goods)): foreach($goods as $key=>$good): ?><div class="goodsbox1">
				<div class="imgbox1"><a href="./goods.php-id=20.htm"><img src="<?php echo ($good["goods_img"]); ?>" alt=""></a></div>
			 <a href="./goods.php-id=20.htm" title="ECSHOP模板中心68ecshop.com测试商品"><?php echo ($good['goods_name']); ?></a><br>
              <font class="goodspice market"><?php echo ($good['market_price']); ?></font>
			 			 <b class="f1"><?php echo ($good['market_price']); ?></b><br>			 
