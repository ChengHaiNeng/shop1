...
<table class="floatTable" align="center" bgcolor="#e3e3e3" border="0" cellpadding="5" cellspacing="1" width="100%">
		<tbody><tr>
			...
			<?php if(is_array($carts)): foreach($carts as $key=>$cart): ?><tr>
			<td bgcolor="#ffffff">
				<a  target="_blank"><?php echo ($cart['goods_name']); ?></a>
			</td>
			...
			<td align="right" bgcolor="#ffffff"><?php echo ($cart['goods_num']); ?></td>
			<td class="price" align="right" bgcolor="#ffffff">￥<?php echo ($cart['shop_price']*$cart['goods_num']); ?>元</td>
